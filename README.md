...
3. Configure options in **Lead Capture > Settings** (Dashboard is the default landing page).
...
- **Lead Capture > Dashboard** is the default landing page.
- **Lead Capture > Campaigns**, **Leads**, and **Analytics** provide focused views.
- **Lead Capture > Settings** contains all infobar configuration fields.
