		...
		<div class="wrap">
			...
			<form method="post" action="options.php">
				...
				<table class="form-table" role="presentation">
					...
					<tr><th scope="row">Keep plugin data when uninstalling</th><td><label><input type="checkbox" name="cmlc_settings[keep_data_on_uninstall]" value="1" <?php checked( 1, $settings['keep_data_on_uninstall'] ); ?>> Preserve settings and captured plugin data if the plugin is deleted.</label></td></tr>
				</table>
				<?php submit_button(); ?>
			</form>
			<h2>Analytics</h2>
