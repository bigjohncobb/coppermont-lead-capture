		...
		<div class="wrap">
			...
			<form method="post" action="options.php">
				...
				<table class="form-table" role="presentation">
					...
					<tr><th scope="row">Allowed Referrers</th><td><input class="regular-text" name="cmlc_settings[allowed_referrers]" value="<?php echo esc_attr( $settings['allowed_referrers'] ); ?>"><p class="description">Comma-separated domains. Use <code>example.com</code> for exact host match only, or <code>*.example.com</code> to also allow subdomains. Matching is strict and does not allow partial contains.</p></td></tr>
