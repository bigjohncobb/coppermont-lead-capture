				...
				<table class="form-table" role="presentation">
					...
					<tr>
						...
						<td>
							...
							<p class="description">When enabled (recommended), uninstalling the plugin keeps all Coppermont Lead Capture data. Disable this only if you want uninstall to permanently delete all plugin-owned options, transients, and custom tables.</p>
						</td>
					</tr>
				</table>
				<?php submit_button(); ?>
