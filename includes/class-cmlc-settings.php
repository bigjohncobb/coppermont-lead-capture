...
class CMLC_Settings {
	...
	/**
	 * Formats conversion rate from settings analytics values.
	 *
	 * @param array<string,mixed> $settings Current settings array.
	 * @return string
	 */
	public static function format_conversion_rate( $settings ) {
		...
		return number_format_i18n( ( $submissions / $impressions ) * 100, 2 ) . '%';
	}

	/**
	 * Renders settings form controls.
	 *
	 * @return void
	 */
